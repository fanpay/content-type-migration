      ...
      <div className="flex items-start">
        ...
        <div className="flex-1">
          <h4 className="text-yellow-800 text-sm font-medium mb-2">
            ⚠️ Using example configuration
          </h4>
          <p className="text-yellow-700 text-xs mb-2">
            Set up environment variables to connect to your real Kontent.ai project:
          </p>
          ...
          <p className="text-yellow-700 text-xs mt-2">
            Copy <code className="bg-yellow-100 px-1 rounded">.env.example</code> to <code className="bg-yellow-100 px-1 rounded">.env</code> and fill in your credentials.
          </p>
        </div>
      </div>
    </div>
